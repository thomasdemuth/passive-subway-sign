...
const STOP_NAMES: Record<string, string> = {
  ...
  "J39": "Marcy Av", "M01": "Middle Village-Metropolitan Av", "M04": "Fresh Pond Rd",
...
const COMBINED_STATIONS: Record<string, string[]> = {
  ...
  "238": ["418"], "418": ["238"],
  // Atlantic Av - Barclays Ctr (235=2/3/4/5, D24=B/Q, R31=D/N/R)
  "235": ["D24", "R31"], "D24": ["235", "R31"], "R31": ["235", "D24"],
  // Jay St - MetroTech
  "A42": ["R28"], "R28": ["A42"],
